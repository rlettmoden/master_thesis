...
# backbone
out_indices = [11]
weights_path_backbone = "/beegfs/work/y0092788/pre_train_weights/vit_b_16-c867db91.pth"
backbone = DOFAViTMM(img_size_lr=image_size)
backbone.init_weights_new(weights_path_backbone, transform_imagenet=True)
