...
use_aux_head = True
for modality in active_modalities:
    modality_config[modality]["aux_head"] = FCNHead(in_channels=out_channels_decoder, num_classes=num_classes, norm=norm_cl)
...
loss = TempoModalLoss(main_loss, auxiliary_losses=aux_losses, auxiliary_loss_weights=loss_weights)
