...
if shared_decoder:
    spatial_decoder = ConvTransformerTokensToEmbeddingNeck(768, out_channels_decoder, norm_cl=norm_cl, 
                                                           only_last_idx = only_last_idx, use_separate_necks=use_separate_necks, only_first_block=only_first_block)
    ...
    for modality in ("s1", "s2"):
        modality_config[modality]["spatial_decoder"] = ConvTransformerTokensToEmbeddingNeck(768, out_channels_decoder, norm_cl=norm_cl, 
                                                           only_last_idx = only_last_idx, use_separate_necks=use_separate_necks, only_first_block=only_first_block)
    modality_config["planet"]["spatial_decoder"] = ConvTransformerTokensToEmbeddingNeck(768, out_channels_decoder, norm_cl=norm_cl, 
                                                        only_last_idx = only_last_idx, use_separate_necks=use_separate_necks, only_first_block=True)
...
net = MultiTempoModalSegmentation(backbone=backbone, modality_config=modality_config, 
                                  ...
                                  has_full_resolution_decoder=True)
