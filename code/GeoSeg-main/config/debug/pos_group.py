...
from geoseg.modules.temporal_encoders.encoding import PositionalEncoding, PositionalTemporalEncoding
...
p_encoder = PositionalTemporalEncoding(d_model=d_model_temporal_encoder, max_len=max_len_pe, T=pe_cst)
...
def get_training_transform(modality_config):
    train_transform = [
        ...
        ToTensor(),
        RandomCropResize(crop_size=(int(image_size*crop_ratio), int(image_size*crop_ratio)), p=0.75),
