...
if shared_temporal:
    temporal_encoder = LTAE2d(in_channels=out_channels_decoder, d_model=d_model_temporal_encoder, mlp=mlp_channes_temporal_encoder)
    for modality in active_modalities:
        modality_config[modality]["temporal_encoder"] = temporal_encoder
else:
    for modality in active_modalities:
        modality_config[modality]["temporal_encoder"] = LTAE2d(in_channels=out_channels_decoder, d_model=d_model_temporal_encoder, mlp=mlp_channes_temporal_encoder)
