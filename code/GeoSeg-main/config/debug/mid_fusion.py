...
num_classes = 8
## MM configurations
active_modalities = ["planet", "s1", "s2"]
modal_fusion = "mid"
...
modality_config["s1"]["temporal_encoder"] = MaxPoolTemporalEncoding()
...
# head 
head = ShallowClassifier(out_channels_decoder, num_classes)
...
net = MultiTempoModalSegmentation(backbone=backbone, modality_config=modality_config, 
                                  ...
                                  use_aux_head=use_aux_head, modal_fusion=modal_fusion)
