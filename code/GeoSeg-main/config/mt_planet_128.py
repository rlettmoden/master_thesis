...
backbone = DOFAViTMM(img_size_lr=image_size, out_indices=out_indices, img_size_hr=128)
...
net = MultiTempoModalSegmentation(backbone=backbone, modality_config=modality_config, 
                                  ...
                                  use_aux_head=use_aux_head, modal_fusion=modal_fusion, architecture=architecture, planet_patch_size=128)
...
train_dataset = MultiModalHarzDataset(data_root, patch_size=128, mode="train", invalid_patch_policy="drop", 
                                      invalid_indices_path=invalid_indices_path, indices_path=splits_path, planet_ratio=planet_ratio,
