...
backbone = DOFAViTMM(img_size_lr=image_size, out_indices=out_indices, num_heads=3, embed_dims=192)
...
out_channels_decoder = 192
use_separate_necks = False
# out_shape_decoder = [image_size//4, image_size//4]
if shared_decoder:
    spatial_decoder = ConvTransformerTokensToEmbeddingNeck(192, out_channels_decoder, norm_cl=norm_cl, 
    ...
    for modality in active_modalities:
        modality_config[modality]["spatial_decoder"] = ConvTransformerTokensToEmbeddingNeck(192, out_channels_decoder, norm_cl=norm_cl, 
                                                           only_last_idx = only_last_idx, use_separate_necks=use_separate_necks)

# temporal encoder
single_temporal = False
single_temporal = False
d_model_temporal_encoder = 192
out_channels_temporal_encoder = 192
# n_head_decoding = 32
d_k = 4
n_head = 8
max_len_pe = 3000
...
modality_config["s1"]["temporal_encoder"] = LTAE2d(in_channels=192, d_model=d_model_temporal_encoder, mlp=mlp_channes_temporal_encoder, n_head=n_head)
