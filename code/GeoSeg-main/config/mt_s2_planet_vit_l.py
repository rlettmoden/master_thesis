...
# backbone
weights_path_backbone = "/beegfs/work/y0092788/pre_train_weights/DOFA_ViT_large_e100.pth"
backbone = DOFAViTMM(img_size_lr=image_size, num_heads=16, embed_dims=1024, num_layers=24, out_indices=[23])
...
if shared_decoder:
    spatial_decoder = ConvTransformerTokensToEmbeddingNeck(1024, out_channels_decoder, norm_cl=norm_cl, 
    ...
    for modality in active_modalities:
        modality_config[modality]["spatial_decoder"] = ConvTransformerTokensToEmbeddingNeck(1024, out_channels_decoder, norm_cl=norm_cl, 
                                                           only_last_idx = only_last_idx, use_separate_necks=use_separate_necks)
